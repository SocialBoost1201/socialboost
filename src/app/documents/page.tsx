...
const DOCUMENTS_DATA = [
  {
    ...
    category: "Web戦略",
    thumbnail: "/images/hero-visual.png", // 仮画像
  },
  {
    ...
    category: "AI導入",
    thumbnail: "/images/works-ai-system.png", // 仮画像
  },
  {
    ...
    category: "システム開発",
    thumbnail: "/images/reason-02.png", // 仮画像
  },
];
  ...
  return (
    <PageLayout>
      ...
      <div className="bg-background-alt py-16 md:py-24 border-b border-gray-100">
        <Container>
          <AnimatedSection>
            <h1 className="text-3xl font-bold tracking-tight text-text-primary md:text-5xl text-center uppercase">Documents</h1>
