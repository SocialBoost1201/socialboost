...
export function HomeFinalContactSection() {
  return (
    <section id="home-contact" className="bg-white py-20 md:py-24 lg:py-28 border-t border-slate-100">
      <Container>
        <div className="mx-auto max-w-4xl rounded-[2rem] border border-slate-200 bg-background-alt p-8 md:p-12 lg:p-14 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black tracking-tight text-brand-navy mb-5 leading-tight">
            プロジェクトの相談先を
            <br className="hidden sm:block" />
            お探しの方へ
          </h2>
          <p className="text-sm md:text-base text-text-secondary leading-relaxed max-w-2xl mx-auto mb-8">
