...
type WorksPreviewSectionProps = {
  showMoreButton?: boolean;
  showLeadCta?: boolean;
};

export async function WorksPreviewSection({ showMoreButton = false, showLeadCta = true }: WorksPreviewSectionProps = {}) {
        ...
        {showLeadCta && (
          <AnimatedSection delay={0.4} className="mt-16 bg-white p-8 md:p-12 rounded-3xl border border-brand-primary/10 shadow-[0_10px_40px_rgba(24,119,242,0.08)] flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 relative overflow-hidden">
            ...
            <div className="w-full md:w-auto shrink-0 relative z-10">
              ...
              <p className="text-center text-xs text-gray-400 mt-3 font-medium">※入力後すぐに閲覧可能です</p>
            </div>
          </AnimatedSection>
        )}
